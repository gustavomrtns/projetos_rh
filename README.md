...
- **Dados & Tecnologia:** People Analytics, dashboards, automação, HTML/CSS, Power BI, SQL e IA aplicada a RH.
...
**Dados & Tecnologia**  
People Analytics · Power BI · SQL · HTML · CSS · IA aplicada a RH
...
Sou profissional com trajetória em **Recursos Humanos, Gestão de Projetos, Dados e Soluções Digitais**. Minha atuação conecta domínio de negócio em **Gestão de Pessoas a Product Thinking, Agilidade, melhoria contínua e tecnologia**, com foco em compreender problemas, estruturar necessidades e transformar demandas em soluções aplicáveis.
